...
impl TryFrom<HandlerRequest> for Request {
    ...
    fn try_from(req: HandlerRequest) -> Result<Self, Self::Error> {
        ...
        if let Some(v) = req.query_params.get("breed") {
            ...
            let decoded_value = decode_param_value(
                v,Some(&serde_json::json!({"maxLength":50,"minLength":2,"type":"string"})),None,None,
            );
        ...
        if let Some(v) = req.query_params.get("age_min") {
            ...
            let decoded_value = decode_param_value(
                v,Some(&serde_json::json!({"maximum":30,"minimum":0,"type":"integer"})),None,None,
            );
        ...
        if let Some(v) = req.query_params.get("tags") {
            ...
            let decoded_value = decode_param_value(
                v,Some(&serde_json::json!({"items":{"type":"string"},"type":"array"})),Some(ParameterStyle::Form),Some(false),
            );

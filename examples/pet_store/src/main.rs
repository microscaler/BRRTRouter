...
fn main() -> io::Result<()> {
    ...
    let cors_middleware = {
        ...
        match builder.build() {
            Ok(global_cors) => {
                ...
                Some(std::sync::Arc::new(brrtrouter::middleware::CorsMiddleware::with_route_policies(global_cors, merged_policies)))
            }
            Err(e) => {
    ...
    println!("[startup] stack_size={stack_size} routes_count={routes_count} hot_reload={hot_reload}");

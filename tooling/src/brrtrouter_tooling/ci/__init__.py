"""CI automation: patch Cargo for BRRTRouter/lifeguard from git; fix path deps; impl deps; get-latest-tag; is-tag; validate versions."""
...
from .fix_impl_dependencies import fix_all_impl_dependencies, update_impl_cargo_dependencies

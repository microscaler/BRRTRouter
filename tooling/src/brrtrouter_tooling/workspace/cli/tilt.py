"""`hauliage tilt` subcommands: setup-kind-registry, setup-persistent-volumes, setup, teardown, logs."""

import sys
from pathlib import Path

from brrtrouter_tooling.workspace.tilt.logs import run as run_logs
from brrtrouter_tooling.workspace.tilt.setup import run as run_setup
from brrtrouter_tooling.workspace.tilt.setup_kind_registry import run as run_setup_kind_registry
from brrtrouter_tooling.workspace.tilt.setup_persistent_volumes import (
    run as run_setup_persistent_volumes,
)
from brrtrouter_tooling.workspace.tilt.teardown import run as run_teardown

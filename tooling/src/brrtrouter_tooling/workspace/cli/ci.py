"""`hauliage ci` subcommands: patch-brrtrouter, fix-cargo-paths, is-tag, get-latest-tag, validate-version."""

import sys
from pathlib import Path

from brrtrouter_tooling.workspace.ci.fix_cargo_paths import run as run_fix_cargo_paths
from brrtrouter_tooling.workspace.ci.get_latest_tag import run as run_get_latest_tag
from brrtrouter_tooling.workspace.ci.is_tag import run as run_is_tag
from brrtrouter_tooling.workspace.ci.patch_brrtrouter import run as run_patch_brrtrouter
from brrtrouter_tooling.workspace.ci.validate_version import run_validate_version_cli

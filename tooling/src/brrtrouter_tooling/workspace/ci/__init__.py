"""CI automation. Re-exports from brrtrouter_tooling.ci when available; Hauliage keeps fix_cargo_paths."""
...
if _BRRT:
    ...
    # Stub missing names so "from brrtrouter_tooling.workspace.ci import X" does not break; callers use submodules.

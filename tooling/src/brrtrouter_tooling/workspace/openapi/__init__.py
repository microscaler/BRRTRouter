...
from brrtrouter_tooling.workspace.openapi.validate import validate_specs
...
# Hauliage's fix_operation_id is used by cli/openapi (works with or without brrtrouter)

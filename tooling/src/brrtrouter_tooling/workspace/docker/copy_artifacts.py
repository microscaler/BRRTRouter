"""Hauliage copy-artifacts: wrap brrtrouter_tooling.docker.copy_artifacts with discovery-derived names."""
...
def run(arch: str, project_root: Path, suite: str | None = None) -> int:
...
def validate_build_artifacts(project_root: Path, suite: str | None = None) -> int:

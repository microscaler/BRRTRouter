"""Tests for brrtrouter_tooling.workspace.ci.validate_version (hauliage ci validate-version)."""
...
from brrtrouter_tooling.workspace.ci.validate_version import (
    compare_versions,
    run,
...
class TestRunValidateVersionCli:
    ...
    def test_fetches_latest_from_github(self) -> None:
        with (
            ...
            patch(
                "brrtrouter_tooling.workspace.ci.get_latest_tag.get_latest_tag",
                return_value="0.39.0",
            ),
        ):

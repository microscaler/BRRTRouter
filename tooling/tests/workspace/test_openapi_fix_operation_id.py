"""TDD: tests for brrtrouter_tooling.workspace.openapi.fix_operation_id (hauliage openapi fix-operation-id-casing)."""
...
class TestIsSnakeCase:
    def test_empty_false(self):
        from brrtrouter_tooling.workspace.openapi.fix_operation_id import is_snake_case
...
class TestToSnakeCase:
    def test_camel_case(self):
        from brrtrouter_tooling.workspace.openapi.fix_operation_id import to_snake_case
...
class TestFindOpenapiFiles:
    def test_finds_yaml_and_yml(self, tmp_path: Path):
        from brrtrouter_tooling.workspace.openapi.fix_operation_id import find_openapi_files
...
class TestProcessFile:
    def test_converts_camel_and_writes(self, tmp_path: Path):
        from brrtrouter_tooling.workspace.openapi.fix_operation_id import process_file
...
class TestRun:
    def test_missing_dir_returns_0_0(self, tmp_path: Path):
        from brrtrouter_tooling.workspace.openapi.fix_operation_id import run

"""TDD: tests for brrtrouter_tooling.workspace.ci.patch_brrtrouter (hauliage ci patch-brrtrouter)."""
...
class TestFindCargoTomls:
    def test_excludes_target_node_modules_git(self, tmp_path: Path):
        from brrtrouter_tooling.workspace.ci.patch_brrtrouter import find_cargo_tomls
...
class TestFindMatches:
    def test_brrtrouter_path_dep_returns_replacement(self):
        from brrtrouter_tooling.workspace.ci.patch_brrtrouter import find_matches
...
class TestPatchFile:
    def test_dry_run_does_not_write(self, tmp_path: Path):
        from brrtrouter_tooling.workspace.ci.patch_brrtrouter import patch_file
...
class TestRun:
    def test_run_no_matches(self, tmp_path: Path, capsys):
        from brrtrouter_tooling.workspace.ci.patch_brrtrouter import run
    ...
    def test_run_patch_and_cargo_update_mocked(self, tmp_path: Path, capsys, monkeypatch):
        ...
        from brrtrouter_tooling.workspace.ci import patch_brrtrouter

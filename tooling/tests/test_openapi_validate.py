"""TDD: tests for brrtrouter_tooling.openapi.validate (brrtrouter openapi validate)."""
...
class TestValidateSpecs:
    ...
    def test_openapi_dir_missing_returns_empty(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.openapi.validate import validate_specs
    ...
    def test_openapi_dir_empty_returns_empty(self, tmp_openapi_dir: tuple[Path, Path]) -> None:
        from brrtrouter_tooling.openapi.validate import validate_specs
    ...
    def test_one_valid_spec_returns_empty(self, tmp_openapi_dir: tuple[Path, Path]) -> None:
        from brrtrouter_tooling.openapi.validate import validate_specs
    ...
    def test_one_invalid_yaml_returns_one_error(self, tmp_openapi_dir: tuple[Path, Path]) -> None:
        from brrtrouter_tooling.openapi.validate import validate_specs
    ...
    def test_one_non_dict_yaml_returns_one_error(self, tmp_openapi_dir: tuple[Path, Path]) -> None:
        from brrtrouter_tooling.openapi.validate import validate_specs
    ...
    def test_two_specs_one_invalid_returns_one_error(
        self, tmp_openapi_dir: tuple[Path, Path]
    ) -> None:
        from brrtrouter_tooling.openapi.validate import validate_specs
    ...
    def test_nested_rglob_finds_openapi_yaml(self, tmp_openapi_dir: tuple[Path, Path]) -> None:
        from brrtrouter_tooling.openapi.validate import validate_specs

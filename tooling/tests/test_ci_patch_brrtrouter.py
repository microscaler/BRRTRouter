"""TDD: tests for brrtrouter_tooling.ci.patch_brrtrouter (brrtrouter ci patch-brrtrouter)."""
...
class TestFindCargoTomls:
    def test_excludes_target_node_modules_git(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.ci import find_cargo_tomls
...
class TestFindMatches:
    def test_brrtrouter_path_dep_returns_replacement(self) -> None:
        from brrtrouter_tooling.ci import find_matches
    ...
    def test_brrtrouter_macros_path_dep_returns_replacement(self) -> None:
        from brrtrouter_tooling.ci import find_matches
    ...
    def test_lifeguard_path_dep_returns_replacement(self) -> None:
        from brrtrouter_tooling.ci import find_matches
    ...
    def test_no_path_dep_returns_empty(self) -> None:
        from brrtrouter_tooling.ci import find_matches
...
class TestPatchFile:
    ...
    def test_audit_does_not_write(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.ci import patch_file
    ...
    def test_patch_replaces_path_with_git(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.ci import patch_file
...
class TestRun:
    def test_run_no_matches(self, tmp_path: Path, capsys) -> None:
        from brrtrouter_tooling.ci import run_patch_brrtrouter as run
    ...
    def test_run_audit_with_matches(self, tmp_path: Path, capsys) -> None:
        from brrtrouter_tooling.ci import run_patch_brrtrouter as run
    ...
    def test_run_dry_run_with_matches(self, tmp_path: Path, capsys) -> None:
        from brrtrouter_tooling.ci import run_patch_brrtrouter as run
    ...
    def test_run_patch_and_cargo_update_mocked(self, tmp_path: Path, capsys, monkeypatch) -> None:
        import subprocess

        from brrtrouter_tooling.ci import run_patch_brrtrouter

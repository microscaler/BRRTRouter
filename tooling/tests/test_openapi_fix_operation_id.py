"""TDD: tests for brrtrouter_tooling.openapi.fix_operation_id (brrtrouter openapi fix-operation-id-casing)."""
...
class TestIsSnakeCase:
    def test_empty_false(self) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import is_snake_case

        assert is_snake_case("") is False

    def test_starts_upper_false(self) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import is_snake_case

        assert is_snake_case("ListPets") is False
        assert is_snake_case("GetUser") is False

    def test_valid_snake_true(self) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import is_snake_case
...
class TestToSnakeCase:
    ...
    def test_kebab_and_spaces(self) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import to_snake_case
...
class TestFindOpenapiFiles:
    def test_finds_yaml_and_yml(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import find_openapi_files
...
class TestProcessFile:
    def test_converts_camel_and_writes(self, tmp_path: Path) -> None:
    ...
    def test_leaves_snake_case_alone(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import process_file
    ...
    def test_quoted_operation_id(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import process_file
...
class TestRun:
    def test_missing_dir_returns_0_0(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import run
    ...
    def test_no_openapi_files_returns_0_0(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import run
    ...
    def test_one_file_with_changes_returns_total_and_touched(self, tmp_path: Path) -> None:
        from brrtrouter_tooling.openapi.fix_operation_id import run

...
If a request doesn't match your spec, BRRTRouter returns RFC 7807 Problem Details (`application/problem+json`) before your handler even runs, with legacy `error` / `reason` / `message` aliases for migration.

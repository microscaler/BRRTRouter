...
Defined in `k8s/velero-deployment.yaml`:
...
**To modify:**
1. Edit `k8s/velero-deployment.yaml`
2. Save
3. Tilt auto-applies changes

### Add More Schedules

Create additional schedule manifests:
...
# Edit k8s/velero-deployment.yaml:

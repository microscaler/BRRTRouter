...
- Keep the **repo root** contributor-facing: `README`, `CONTRIBUTING`, license, Cargo, Tilt. Narrative / pitch material lives under [`docs/marketing/`](./docs/marketing/). Suite brochure lives in **[photon](https://github.com/microscaler/photon)** (`brochure/`; pointer [`website/`](./website/)). Public learn path: [`docs/BUILDING_WITH_BRRTROUTER.md`](./docs/BUILDING_WITH_BRRTROUTER.md) → Sesame-IDAM.
